...
$(window).scroll(function () {
  if ($(window).scrollTop() > 2000) {
    ...
    $(".anliMain ul li:nth-child(5)").attr('id', 'tc5');
    $(".anliMain ul li:nth-child(6)").attr('id', 'tc5');
    ...
    $(".anliMain ul li:nth-child(5)").removeAttr('id', 'tc5');
    $(".anliMain ul li:nth-child(6)").removeAttr('id', 'tc6');
  }
});
...
$(window).scroll(function () {
  if ($(window).scrollTop() > 2500) {
    ...
    $(".hezuoMain ul li:nth-child(6)").attr('id', 'tc6');
    $(".hezuoMain ul li:nth-child(7)").attr('id', 'tc7');
    $(".hezuoMain ul li:nth-child(8)").attr('id', 'tc8');
    $(".hezuoMain ul li:nth-child(9)").attr('id', 'tc9');
    $(".hezuoMain ul li:nth-child(10)").attr('id', 'tc10');
    $(".hezuoMain ul li:nth-child(11)").attr('id', 'tc11');
  } else {
    ...
    $(".hezuoMain ul li:nth-child(6)").removeAttr('id', 'tc6');
    $(".hezuoMain ul li:nth-child(7)").removeAttr('id', 'tc7');
    $(".hezuoMain ul li:nth-child(8)").removeAttr('id', 'tc8');
    $(".hezuoMain ul li:nth-child(9)").removeAttr('id', 'tc9');
    $(".hezuoMain ul li:nth-child(10)").removeAttr('id', 'tc10');
    $(".hezuoMain ul li:nth-child(11)").removeAttr('id', 'tc11');
  }
});
